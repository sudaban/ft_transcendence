...
test-health:
	...
	@echo "Kibana: https://localhost:$(HTTPS_PORT)/kibana/"
	@echo ""
	...
	@echo ""
	@curl -sk https://localhost:$(HTTPS_PORT)/prometheus/-/healthy || echo "❌ Prometheus: FAILED"
	@echo ""
	@curl -sk https://localhost:$(HTTPS_PORT)/grafana/api/health || echo "❌ Grafana: FAILED"
	@echo ""
	@curl -sk https://localhost:$(HTTPS_PORT)/kibana/api/status || echo "❌ Kibana: FAILED"
	@echo ""
